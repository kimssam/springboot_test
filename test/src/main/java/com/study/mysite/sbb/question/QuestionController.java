...
import com.study.mysite.sbb.answer.AnswerForm;
...
//		List<Question> questionList = this.questionRepository.findAll();
		 ...
		 // native-true-03) Pageable 객체 생성
	    Pageable pageable = PageRequest.of(page, 10);  // 페이지 크기를 10으로 설정 (필요에 따라 변경 가능)
	    
	    
//		Page<Question> paging =this.questionService.getList(page, kw);

	    //native-true-04)getList()매개변수 pageable로 수정
		Page<Question> paging =this.questionService.getList(pageable, kw);
